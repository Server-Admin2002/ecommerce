 ...
 <li><a href="contactdata.php">Contact Form Details</a></li>
   ...
   <div class="col-sm-8 col-xs-12">
      ...
      <div class="row">
		  ...
		  <div class="col-sm-10">
			<center><h2>Customer Order Details</h2></center><br>
		</div>
 <div class="col-sm-2">
		  </div>
	...
	orders.productId,orders.quantity,orders.userId,orders.totamt,orders.orderDate,orders.paymentMethod,orders.orderStatus,orders.trackId
FROM products
INNER JOIN orders ON products.product_id=orders.productId  ORDER BY orderDate DESC";
			...
			echo "<form method='post' action=''>";
				...
				while ($row=mysqli_fetch_array($query1)) {
					...
					if(isset($payment))
					{
							...
							<td>'.$n++.'</td>
							<td>'.$orderdt.'</td>
							<td><a href="userdetails.php?uId='.$userId1.'">Click</a></td>
